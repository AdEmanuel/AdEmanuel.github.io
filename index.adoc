...
.Ilustração do deslocamento de bits feitos no código.
...
image::PDI/1/desafio-esteganografia.png[desafio-esteganografia, 300, 400]

[#i.png]
.Saída - im_recuperada.png
image::PDI/1/im_recuperada.png[im_recuperada, 300, 400]
