...
image::PDI/4/FormulaHomomorfico.png[FormulaHomomorfico, 300, 200]
...
image::PDI/4/FormulaD.png[FormulaD, 300, 200]
...
[.text-justify]
O par aninhado de for’s seguinte, criteriza de maneira diferente a adição dos círculos que havia sido anteriormente. Ele perocerre os pixels da imagem points e ao identficar que trata-se de um pixel de borda, desenha um círculo na posição correspodente.
...
Tendo sido explicitado os principais trehcos que compõem o algoritmo parte-se para sua execução. Como indicado, foi escolhida uma foto minha para ser a imagem de entrada.

[#Adson.png]
.Imagem de Entrada cannypoint 
image::PDI/5/Adson.png[labeling, 250, 250]

Ao executar o algoritmo mostra à esqueda a imagem de entrada com aplicação do filtro de canny, à direta a imagem pontilhista e a barra de controle de Thresholding inferior. 

[#cannypoints1.png]
.Execução do cannypoints - Thresholding inferior inicial
image::PDI/5/cannypoints1.png[cannypoints1, 250, 250]
...
image::PDI/5/cannypoints2.png[cannypoints2, 250, 250]

[#cannypoints3.png]
.Execução do cannypoints - Thresholding inferior = 200
image::PDI/5/cannypoints3.png[cannypoints3, 250, 250]
