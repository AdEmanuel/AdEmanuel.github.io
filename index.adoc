...
image::PDI/4/FormulaHomomorfico.png[FormulaHomomorfico, 400, 200]
...
[#FormulaD.png]
.Fórmula do Filtro Homomórfico
image::PDI/4/FormulaD.png[FormulaD, 400, 200]
...
[.text-justify]
No código, o filtro homomórifico é criado a partir da função makeHomomorphicFIlter, onde é implementado o cálculo descrito anteriormente. Dessa forma, o g do código corresponde ao  gama da função e os valores para gh, gl, c e d foram definidos experimentalmente. 
...
image::PDI/3/Parceria.png[Parceria, 250, 250]

[#out-homomorphic-filter.png]
.Saída do Filtro Homomórfico
image::PDI/3/Parceria.png[out-homomorphic-filter, 250, 250]
